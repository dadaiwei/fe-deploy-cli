...
// 第三步，连接SSH
async function connectSSH(config, password) {
  const { host, port, username, privateKey, passphrase, distPath } = config;
  const sshConfig = {
    host,
    port,
    username,
